...
public class UpdateHandler extends BaseHandlerStd {
    ...
    private void handleTagUpdates(ResourceHandlerRequest<ResourceModel> resourceHandlerRequest,
                                  ...
                                  AmazonWebServicesClientProxy proxy,
                                  Logger logger) {
        final String pathId = resourceHandlerRequest.getPreviousResourceState().getNetworkInsightsPathId();
        ...
        addTags(pathId, tagsToBeAdded, client, proxy, logger);
    ...
    private void addTags(String pathId,
        ...
        if (!tagsToBeAdded.isEmpty()) {
            final CreateTagsRequest createTagsRequest = Translator.translateToCreateTagsRequest(tagsToBeAdded, pathId);
    ...
    private void deleteTags(String pathId,
        ...
        if (!tagsToBeDeleted.isEmpty()) {
            DeleteTagsRequest deleteTagsRequest = Translator.translateToDeleteTagsRequest(tagsToBeDeleted, pathId);
